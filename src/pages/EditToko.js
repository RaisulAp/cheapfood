...
function EditToko() {
  ...
  const submitHandler = async (e) => {
    ...
    await axios.put("http://localhost:8080/toko/"+toko_id, {
      nama: nama,
      alamat: alamat,
      hari_tutup: hari,
      jam_buka: jamBuka,
        ...
        <div className='w-full lg:w-2/6'>
          ...
          <form onSubmit={submitHandler} className='w-full'>
            <div className='space-y-3 mt-5'>
              ...
              <div className='pt-3'>
                  <button type="submit" className='bg-green-500 py-1 px-6 rounded-xl text-white font-semibold float-right '>Edit Toko</button>
                </div>
            </div>
          </form>
        </div>
